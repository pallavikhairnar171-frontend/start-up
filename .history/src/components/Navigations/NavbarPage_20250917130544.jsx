  ...
  return (
    <div id='fullScreen' className="h-screen py-40 w-full absolute bg-amber-950">
      <div id="all-linkk" className="">
        ...
        <div className="link  border-y-1 ">
          <h1 className="font-[font2]  text-[6vw] uppercase leading-[0.7] pt-4 text-center">About us</h1>
          {/* <div>
            <div>
              <h2>Pour top viss</h2>
              <img src={img} alt="" />
        ...
        <div className="link  border-y-1 ">
          <h1 className="font-[font2]  text-[6vw] uppercase leading-[0.7] pt-4 text-center">Calulator</h1>
          {/* <div>
            <div>
              <h2>Pour top viss</h2>
              <img src={img} alt="" />
