...
console.log(navOpen,'========')
 ...
 useGSAP(function () {
  ...
  return (
    ...
    ref={fullScreenDiv}
      id="fullScreen"
      className="h-screen hidden overflow-hidden  w-full absolute bg-black"
    >
      ...
      <div ref={fullScreenNav} className="relative">
        <div className="flex w-full p-5 justify-between items-start">
          ...
          <div className="h-28 relative  w-28 cursor-pointer" onClick={()=>SetNavOpen(false)}>
        ...
        <div id="all-linkk" className="py-40">
          <div className="link origin-top relative transition-all  border-t-1 ">
