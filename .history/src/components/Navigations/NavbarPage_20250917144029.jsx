  ...
  return (
    ...
    >
      <div className="flex w-full p-5 justify-between items-start">
        ...
        <div className="h-30 relative  w-30 cursor-pointer bg-red-950">
          <div className="h-30 w-0.5 -rotate-45 origin-top absolute bg-white"></div>
          <div className="h-30 w-0.5 right-0 rotate-45 origin-top absolute bg-white"></div>
        </div>
      </div>
