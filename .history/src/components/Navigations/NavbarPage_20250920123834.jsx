...
const NavbarPage = () => {
  ...
  return (
    <div
      ref={fullScreenDiv}
      id="fullScreen"
      className="hidden fullScreen_Nav h-screen z-50 overflow-hidden  w-full absolute bg-slate-800"
    >
      <div className="h-screen w-full fixed">
        <div className="h-full w-full flex  ">
          <div className="animi h-full w-1/5 bg-slate-800"></div>
          <div className="animi h-full w-1/5 bg-slate-800"></div>
          <div className="animi h-full w-1/5 bg-slate-800"></div>
          <div className="animi h-full w-1/5 bg-slate-800"></div>
          <div className="animi h-full w-1/5 bg-slate-800"></div>
        ...
        <div id="all-linkk" className="py-40">
          <div className="link origin-top relative  border-t-1 ">
            ...
            <div className="absolute moveLink top-0 flex">
              <div className="moveX flex bg-slate-400   items-center">
