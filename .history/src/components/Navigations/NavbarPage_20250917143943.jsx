  ...
  return (
    ...
    >
      <div className="flex w-full p-5 justify-between items-start">
        ...
        <div className="h-32 relative  w-32 cursor-pointer">
          <div className="h-44 w-0.5 -rotate-45 origin-top absolute bg-white"></div>
          <div className="h-44 w-0.5 right-0 rotate-45 origin-top absolute bg-white"></div>
        </div>
      </div>
